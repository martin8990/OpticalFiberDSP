...
import PlotFunctions.pyqt_bitmimoplot as bmp
...
sig = signals.SignalQAMGrayCoded(16,N , fb=25e9, nmodes=nmodes)
...
try : 
    print("BER_Martin = ",eval.calculate_BER(sig_martin,range(t_conv,t_stop)))
except:
    print("BER failed")
